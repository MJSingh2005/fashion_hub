...
<div class="col-sm-12" >
    <div class="col-sm-2">
        <img src="image/m3.png" class="img img-responsive" style="margin-top: 30%;margin-left:10%;height: 80px;width:500px">
    </div>
    <div class="col-sm-1">
    </div>
    <div class="col-sm-7"><br>
        <h1 style="font-size: 50px; font-family: serif">Fashion With Narrow Style !</h1>
        <h3>Affiliated to Goverment of Uttar Pradesh</h3>
       
    </div>
    <div class="col-sm-2">
         <img src="image\p.png" class="img img-responsive" style="height:200px; width: 200px; margin-top: 5%;margin-left: 5%">
    </div>
</div>
<!--  end code for title-->
